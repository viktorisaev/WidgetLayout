...
IMGUI_API bool        ImGui_ImplDX12_Init(void* hwnd, int numFramesInFlight, ID3D12Device* device, D3D12_CPU_DESCRIPTOR_HANDLE fontSrvCpuDescHandle, D3D12_GPU_DESCRIPTOR_HANDLE fontSrvGpuDescHandle);
